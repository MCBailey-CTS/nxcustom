...
1) Copy the contents of the ...\NX\UGII\table_files folder to NXcustom\NX1899library\Tables

2) Uncomment the following line in the NXcustom\NX1899library\NX_env.dat file:
