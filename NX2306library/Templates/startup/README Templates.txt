NXcustom Templates                                 Last Modified: 19Aug2016

There are 2 methods for configuring your File New Templates.

1. Preferred method
Put your custom pax files in the UGII_TEMPLATE_DIR=${NX_CUSTOM_LIB}\Templates\startup folder.
...
For instance, the MyTemplates tab in File New are from files in the NX110custom\NX110library\Templates\startup folder.
...
The MyTemplates tab in File New are from files in the NX110custom\NX110library\Templates folder.

The following line in the NX110custom\NX110library\NX110env.dat file points to the Templates folder.

# UGII_TEMPLATE_DIR=${NX_CUSTOM_LIB}\Templates
...
If you only want the files in the NX110custom\NX110library\Templates control your file new, remove
all the other pax files from the NX110custom\NX110library\Templates\startup folder. or remove the 
entry from the NX110custom\NX110library\custom_dirs.dat file.
